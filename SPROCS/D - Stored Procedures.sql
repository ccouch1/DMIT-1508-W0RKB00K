...
-- @@ERROR is a global variable that contains the error number for that was generated by the last INSERT, UPDATE or DELETE statement.
...
AS
    ...
    BEGIN -- {
        ...
        ELSE
        BEGIN -- {
			-- THE EXISTS() function checks to see if there are any rows resluting from a query. 
